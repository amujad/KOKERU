                            ...
                            <div class="pt-4 row row-cols-1 row-cols-md-3">
                                @foreach($ruangan as $ruang)
                                    <div class="col mb-4" style="color:white">
                                        ...
                                        <a class="btn-primary" href="Tugas/{{$ruang->idruangan}}/viewBukti">
                                            <div class="card bg-success shadow-sm" id="card-room">
                                        @else
                                        <a class="btn-primary" href="" id="upload" data-toggle="modal" data-target="#uploadBukti" data-id="{{$ruang->idruangan}}">
